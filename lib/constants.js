...
const HELPERS = {
  ...
  methodName: () => (...x) => changeCase.camelCase(HELPERS.singularize()(...x)),
  methodNames: () => (...x) => changeCase.camelCase(HELPERS.pluralize()(...x)),
  className: () => (...x) => changeCase.pascalCase(HELPERS.singularize()(...x)),
  classNames: () => (...x) => changeCase.pascalCase(HELPERS.pluralize()(...x)),
};
