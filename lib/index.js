...
function _runTask($, task, logger, helpers) {
  const _values = {};
    ...
    .then(() => {
      ...
      return _actions.reduce((prev, a) => {
        ...
        const _destPath = () => {
          ...
          return path.join($.cwd, _render(a.dest, _values, helpers, _.HELPERS));
        };
        ...
        const _getTemplate = () => {
          ...
          if (!(typeof a.template === 'undefined' && typeof a.templateFile === 'undefined')) {
            ...
            return _render(tpl, _values, helpers, _.HELPERS);
          }
        ...
        const _repository = () => {
          const _url = a.gitUrl ? _render(a.gitUrl || '', _values, helpers, _.HELPERS) : '';
  ...
  return {
    ...
    runGenerator(name, defaults) {
      ...
      if (typeof name === 'object') {
        return Promise.resolve().then(() =>
          _runTask.call(this, { cwd, io: _config, options, defaults }, name, _logger, _helpers));
      }
