        ...
        return prev.then(() => {
          ...
          switch (a.type) {
            case 'copy': {
              ...
              return options.copy !== false && _sourceFiles().reduce((_prev, cur) => _prev.then(() => {
                ...
                return logger('write', path.relative($.cwd, _dest), end => _askIf($.io,
                  ...
                  .then(result => {
                    /* istanbul ignore else */
                    if (result === 'abort') {
                      throw new Error(`Source '${_src}' cannot be copied!`);
                    }
            ...
            case 'clean':
              ...
              return logger('remove', path.relative($.cwd, _dest), end => {
                rimraf.sync(_dest);
                end();
              });
