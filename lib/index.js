        ...
        switch (a.type) {
            ...
            return options.copy !== false && _sourceFiles().reduce((_prev, cur) =>
              _prev.then(() => {
                ...
                .then(result => {
                  ...
                  logger(_skipAll || result === 'skip' ? 'skip' : 'save', path.relative($.cwd, _dest));
                });
              }), Promise.resolve());
          }
          ...
          case 'modify': {
            ...
            if (a.unless
              ...
              logger('skip', path.relative($.cwd, _dest));
              return;
            }
            ...
            logger('change', path.relative($.cwd, _dest));
              ...
              new Promise((resolve, reject) => {
                ...
                downloadRepo(_src, _dest, err => {
                  if (err) {
                    ...
                    // logger.write(`  ${chalk.green('clone')}  ${path.relative($.cwd, _dest) || '.'} (${_src})\r\n`);
          ...
          case 'add':
            ...
            .then(result => {
              ...
              logger(result === 'skip' ? 'skip' : 'save', path.relative($.cwd, _dest));
            });
